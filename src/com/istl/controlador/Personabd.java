...
public class Personabd {
    ...
    public boolean editar(Persona persona) throws SQLException {
        ...
        if (persona.getFecha_nacimiento() == null) {
            sql = "UPDATE `ejercicio`.`persona` SET "
            ...
            sql = "UPDATE `ejercicio`.`persona1` SET "
                    + "`Cedula` = '" + persona.getCedula() + "', "
                    + "`Nombre` = '" + persona.getNombre() + "', "
                    + "`Apellido` = '" + persona.getApellido() + "', "
                    + "`Direccion` = '" + persona.getDireccion() + "', "
...
//    }
    public Persona buscarPersonasNumero(String numero) {
        ...
        String sql = "SELECT * FROM bdejercicio.persona1 where Telefono like '" + numero + "';";
    ...
    public List<Persona> buscarPersonasNombre(String nombre) {
        ...
        String sql = "SELECT * FROM bdejercicio.persona where Nombre like \"%" + nombre + "%\"";
